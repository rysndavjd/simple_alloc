...
use crate::{
    common::{
        ...
        BAllocatorError, HEAP_END_OVERFLOWED, HEAP_NOT_POWER_TWO, HEAP_SIZE_ZERO, HEAP_START_NULL,
        align_up,
    },
    std::{
        alloc::Layout,
...
unsafe impl BAllocator for Mutex<LockedBuddy> {
    ...
    fn deallocate(&self, ptr: NonNull<u8>, layout: Layout) {
        ...
        allocator.combine_free_buddies(ptr.as_ptr() as *mut u8 as usize);
    }
}
