# Simple_alloc
A collection of simple, pure Rust memory allocators for `no_std` and embedded environments with support for `std` environments. Prioritizing simplicity and minimal dependencies.


| Memory Allocator | Status | Atomic Variant | Blocking Variant | 
|------------------|--------|----------------|--------------|
| [Bump Alloc](https://os.phil-opp.com/allocator-designs/#bump-allocator) | Works | Yes | Yes |
| [Linked List Alloc](https://os.phil-opp.com/allocator-designs/#linked-list-allocator) | Inprogress | No | No |
| [Buddy Alloc](https://en.wikipedia.org/wiki/Buddy_memory_allocation) |  Works | No | Yes |
| [Slab Alloc](https://en.wikipedia.org/wiki/Slab_allocation) | Inprogress | No | No |
